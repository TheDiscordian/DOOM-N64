...
case "${BENCH_FORCE_MESH:-}${BENCH_FORCE_MESH_FLOORS:-}${BENCH_FORCE_MESH_WORLDZ:-}${BENCH_FORCE_MESH_PMESH:-}${BENCH_FORCE_MESH_CULL:-}${BENCH_FORCE_MESH_LEAF_RSP:-}${BENCH_FORCE_MESH_RSP:-}${BENCH_FORCE_MESH_RSP_EMIT:-}" in
...
if [ -z "$RUN_ROM" ]; then
    ...
    for v in BENCH_MP BENCH_FORCE_RDP BENCH_FORCE_PLANES_ONLY BENCH_FORCE_WALLS_ONLY \
             ...
             BENCH_FORCE_MESH_PMESH BENCH_FORCE_MESH_MASKED BENCH_FORCE_MESH_SPRITES \
             BENCH_FORCE_MESH_LEAF_RSP BENCH_FORCE_MESH_LEAF_EMIT BENCH_FORCE_MESH_RSP \
             BENCH_FORCE_MESH_RSP_EMIT \
             BENCH_FORCE_SHOW_FPS BENCH_FORCE_FIXEDCOLORMAP BENCH_MARKS BENCH_VOID_SCAN \
             PVS_PROBE BSPWALK_PROBE; do
        eval "val=\${$v:-}"
