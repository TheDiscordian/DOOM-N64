...
case "${BENCH_FORCE_MESH:-}${BENCH_FORCE_MESH_FLOORS:-}${BENCH_FORCE_MESH_CULL:-}${BENCH_FORCE_MESH_LEAF_RSP:-}${BENCH_FORCE_MESH_RSP:-}${BENCH_FORCE_MESH_RSP_EMIT:-}" in
...
if [ -z "$RUN_ROM" ]; then
    ...
    for v in BENCH_MP BENCH_FORCE_RDP BENCH_FORCE_PLANES_ONLY BENCH_FORCE_WALLS_ONLY \
             ...
             BENCH_FORCE_MESH_RSP_EMIT BENCH_FORCE_MESH_LEAF_CELLS BENCH_FORCE_MESH_LEAF_BANDS \
             BENCH_FORCE_MESH_LEAF_CPU_EMIT \
             BENCH_FORCE_SHOW_FPS BENCH_FORCE_FIXEDCOLORMAP BENCH_MARKS PVS_PROBE \
             PLANE_GEOM_TRACE PLANE_GEOM_TRACE_FRAME PLANE_GEOM_TRACE_FRAME2 PLANE_GEOM_TRACE_POLYS; do
        eval "val=\${$v:-}"
