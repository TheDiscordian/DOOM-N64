...
preset_flags() {
    case "$1" in
        ...
        mesh-sprites)   echo "BENCH_FORCE_MESH=1 BENCH_FORCE_MESH_PMESH=1 BENCH_FORCE_MESH_MASKED=1 BENCH_FORCE_MESH_SPRITES=1" ;; # + Phase C: sprites on Z
...
PRESET_LIST="software rdp planes-only walls-only mesh mesh-cpu mesh-cull mesh-worldz mesh-pmesh mesh-pmesh-masked mesh-sprites mesh-floors mesh-leaf-rsp mesh-rsp-emit"
